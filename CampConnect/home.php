...
<body>
    ...
    <div class="row">
      ...
      <h3 style="float: left; padding-left: 35px; color: white; font-size: 40px;font-weight: bold;"><span >Camp</span><span>Connect</span></h3>	
        ...
        <li><a href="message.php">MESSAGES</a></li>
    		...
    		<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="home.php" ><?php if(isset($_SESSION['email']))
    $word=$_SESSION['email']; echo $word?><span class="caret"></span></a>
